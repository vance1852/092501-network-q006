...
PERMISSIONS={"viewer":{"read"},"operator":{"read","measure","work_order","allocate","dispatch_plan"},"engineer":{"read","measure","work_order","allocate","analyze","dispatch_plan"},"quality":{"read","measure","work_order","allocate","analyze","approve","dispatch_plan"},"dispatcher":{"read","work_order","allocate","dispatch_plan","dispatch_confirm"},"admin":{"read","measure","work_order","allocate","analyze","approve","admin","dispatch_plan","dispatch_confirm"}}
